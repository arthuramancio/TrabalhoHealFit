...
public class homem_hipertrofia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homem_hipertrofia);
        ...
        bttIniciante.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), homem_hipertrofia_nv1.class);
        ...
        bttAvancado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), homem_hipertrofia_nv2.class);
                startActivity(intent);
